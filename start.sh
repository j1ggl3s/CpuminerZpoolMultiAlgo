...
# --- Allium ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a allium --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "allium $HASH MH/s"
FACTOR="allium=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Argon2d4096 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a argon2d4096 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "argon2d4096 $HASH MH/s"
FACTOR="$FACTOR,argon2d4096=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Argon2d500 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a argon2d500 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "argon2d500 $HASH MH/s"
FACTOR="$FACTOR,argon2d500=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Binarium ---
HASH=$(echo "$(/cpuminer-easy-binarium/cpuminer -a Binarium_hash_v1 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "binarium $HASH MH/s"
FACTOR="$FACTOR,binarium-v1=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- BMW512 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a bmw512 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 /1000" | bc -l | awk '{printf "%.8f", $0}')
...
for i in {1..$BMRETRY}; do 
  HASH=$(echo "$(/cpuminer-opt-cpupower/cpuminer -a cpupower --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
  if [ "$HASH" != "0.00000000" ] && [ ! -z "$HASH" ]; then break; fi 
...
# --- Curvehash (Uses live mining, parsing logic is different and already ok) ---
...
# --- Keccakc ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a keccakc --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 /1000" | bc -l | awk '{printf "%.8f", $0}')
echo "keccakc $HASH GH/s"
FACTOR="$FACTOR,keccakc=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Lyra2rev3 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a lyra2rev3 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 /1000" | bc -l | awk '{printf "%.8f", $0}')
echo "lyra2v3 $HASH GH/s"
FACTOR="$FACTOR,lyra2v3=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Lyra2z ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a lyra2z --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 /1000" | bc -l | awk '{printf "%.8f", $0}')
echo "lyra2z $HASH GH/s"
FACTOR="$FACTOR,lyra2z=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Lyra2z330 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a lyra2z330 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "lyra2z330 $HASH MH/s"
FACTOR="$FACTOR,lyra2z330=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- M7M ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a m7m --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "m7m $HASH MH/s"
FACTOR="$FACTOR,m7m=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Power2b ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a power2b --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "power2b $HASH KH/s"
FACTOR="$FACTOR,power2b=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Phi2 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a phi2 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "phi2 $HASH MH/s"
FACTOR="$FACTOR,phi2=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- X11gost (Sib) ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a x11gost --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "sib $HASH GH/s"
FACTOR="$FACTOR,sib=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- X14 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a x14 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "x14 $HASH GH/s"
FACTOR="$FACTOR,x14=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- X21s ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a x21s --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "x21s $HASH MH/s"
FACTOR="$FACTOR,x21s=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- X16r ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a x16r --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "x16r $HASH GH/s"
FACTOR="$FACTOR,x16r=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- X25x ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a x25x --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000 / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "x25x $HASH MH/s"
FACTOR="$FACTOR,x25x=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Yescrypt ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a yescrypt --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "yescrypt $HASH KH/s"
FACTOR="$FACTOR,yescrypt=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Yescryptr32 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a yescryptr32 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
echo "yescryptr32 $HASH KH/s"
FACTOR="$FACTOR,yescryptR32=$(echo $HASH \* 1000 | bc -l | awk '{printf "%.2f", $0}')"
unset HASH

# --- Yespower ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a yespower --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
...
# --- YespowerIC ---
for i in {1..$BMRETRY}; do
  HASH=$(echo "$(/isotopec-cpuminer/cpuminer -a yespowerIC --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
  if [ "$HASH" != "0.00000000" ] && [ ! -z "$HASH" ]; then break; fi
...
# --- Yespowerltncg ---
for i in {1..$BMRETRY}; do
  HASH=$(echo "$(/isotopec-cpuminer/cpuminer -a yespowerltncg --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
  if [ "$HASH" != "0.00000000" ] && [ ! -z "$HASH" ]; then break; fi
...
# --- Yespowerr16 ---
HASH=$(echo "$(/cpuminer-opt/cpuminer -a yespowerr16 --benchmark --time-limit=$BMSEC 2>&1 > /dev/null | grep "Benchmark:" | tail -1 | awk '{v=$4; u=$5; if(u~/kH/)v*=1000; if(u~/MH/)v*=1000000; if(u~/GH/)v*=1000000000; print v}') / 1000" | bc -l | awk '{printf "%.8f", $0}')
